...
dataset = pd.read_excel("Updated_Final_Processed_Data_Set_IP_ID_12_12_2018.xlsx")
...
plot_confusion_matrix(cm, 
                      normalize    = False,
                      target_names = ['0', '1'],
                      title        = "Logistic Regression Classifier in Network Layer")
...
plt.ylim([0.0, 1.05])
plt.xlim([0.0, 1.0])
plt.title('Precision-Recall curve for Logistic Regression in Network Layer')
